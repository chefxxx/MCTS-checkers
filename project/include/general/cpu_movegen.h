...
std::vector<Move> createAllPawnMoves(size_t t_moversMask, size_t t_emptyFiles, Colour t_moversColour);
std::vector<Move>
createOnePawnsMove(int t_idx, size_t t_emptyFiles, Colour t_moversColour);

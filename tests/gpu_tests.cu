...
TEST_F(GpuMovegenTests, whitePawnCaptureUpRight) {
    GPU_Board board;
    board.pawns[white] = 1ULL << 18;
    board.pawns[black] = 1ULL << 27;
...
TEST_F(GpuMovegenTests, whitePawnCaptureUpLeft) {
    GPU_Board board;
    board.pawns[white] = 1ULL << 18;
...
TEST_F(GpuMovegenTests, whitePawnCaptureDownLeft) {
    GPU_Board board;
    board.pawns[white] = 1ULL << 18;
...
TEST_F(GpuMovegenTests, whitePawnCaptureDownRight) {
    GPU_Board board;
    board.pawns[white] = 1ULL << 18;
